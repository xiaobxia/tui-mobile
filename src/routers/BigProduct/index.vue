<template>
  <div class="page-new-product">
    <mt-header title="大额低息" :fixed="true">
    ...
    <div class="main-body">
      <div class="ad-wrap">
        ...
        <span>据统计，申请<span class="yellow-text">5个以上</span>产品，贷款成功率超过95%</span>
      </div>
      <product-card-simple type="big" :list="list"></product-card-simple>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    initPage () {
      ...
      // })
      this.$http.get('customer/getProductsBig').then((res) => {
